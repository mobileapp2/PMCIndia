...
public class WithdrawAmountEntity implements Serializable {
    String working_wallet;
    Integer binary_income_balance,direct_income_balance,level_income_balance,principal_income,roi_balance,topup_wallet,transfer_wallet;

    public WithdrawAmountEntity(String working_wallet, Integer binary_income_balance, Integer direct_income_balance, Integer level_income_balance, Integer principal_income, Integer roi_balance, Integer topup_wallet, Integer transfer_wallet) {
